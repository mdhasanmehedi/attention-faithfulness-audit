...
box(0.6, 0.8, 8.8, 1.0,
    "Compare against random 20% masking (control) \u2014\none-sided Wilcoxon signed-rank test, \u03b1=0.05, n=500",
    fc="#F5EEDD", fontsize=9.3)

plt.tight_layout()
plt.savefig("fig2_protocol_schematic.png", dpi=200, bbox_inches="tight")
print("saved")
