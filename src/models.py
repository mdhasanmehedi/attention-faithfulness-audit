...
Character-level CNN-Transformer hybrid for malicious URL detection, as
described in the accompanying paper. Combines parallel multi-scale
convolutional filters with a Transformer encoder over the full-resolution
character sequence, followed by mean pooling and a linear classification
head.
"""
